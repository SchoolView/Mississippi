###################################################################################
###
### Script to generate Mississippi bubblePlots for 2013-2014 data
###
###################################################################################
...
bPlot.data.school <- subset(bPlot.data.school, YEAR=="2013_2014")
...
bPlot.data.school.grade <- subset(bPlot.data.school.grade, YEAR=="2013_2014")
...
bPlot.data.instructor <- subset(bPlot.data.instructor, YEAR=="2013_2014")
...
bPlot.data.instructor.grade <- subset(bPlot.data.instructor.grade, YEAR=="2013_2014")
...
write.table(bPlot.data.school, file="Data/Mississippi_District_by_School_Summary_Data_2013_2014.dat", na="", row.names=FALSE, quote=FALSE, sep="|")
write.table(bPlot.data.school.grade, file="Data/Mississippi_District_by_School_by_Grade_Summary_Data_2013_2014.dat", na="", row.names=FALSE, quote=FALSE, sep="|")
write.table(bPlot.data.instructor, file="Data/Mississippi_District_by_School_by_Instructor_Summary_Data_2013_2014.dat", na="", row.names=FALSE, quote=FALSE, sep="|")
write.table(bPlot.data.instructor.grade, file="Data/Mississippi_District_by_School_by_Instructor_by_Grade_Summary_Data_2013_2014.dat", na="", row.names=FALSE, quote=FALSE, sep="|")
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2013_2014", capwords(i), "State_School_Performance", sep="_"), ".pdf", sep=""),
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste(j, "2013_2014", capwords(i), "School_Performance", sep="_"), ".pdf", sep=""),
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2013_2014", capwords(i), "State_Teacher_Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2013_2014", capwords(i), "State_Teacher_Performance (Prior Achievement)", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste(j, "2013_2014", capwords(i), "Teacher_Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "District", j),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste(j, "2013_2014", capwords(i), "Teacher_Performance (Prior Achievement)", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "District", j),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
}
...
#        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
#        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
#        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste(k, "2013_2014", capwords(i), "Performance", sep="_"), ".pdf", sep=""),
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2013_2014", capwords(i), "Pilot_School Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2013_2014", capwords(i), "Pilot_School Teacher Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2013_2014", capwords(i), "Pilot_School Teacher Performance (Prior Achievement)", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2013_2014", capwords(i), "Grade", j, "Pilot_School_Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2013_2014", capwords(i), "SIG_School_Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2013_2014", capwords(i), "SIG_School_Teacher Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2013_2014", capwords(i), "SIG_School_Teacher Performance (Prior Achievement)", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2013_2014", capwords(i), "Grade", j, "SIG_School_Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2013_2014", capwords(i), "Grade", j, "Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste(k, "2013_2014", capwords(i), "Grade", j, "Performance", sep="_"), ".pdf", sep=""),
