###################################################################################
###
### Script to generate Mississippi bubblePlots for 2011-2012
###
###################################################################################
...
Pilot_District_Schools <- read.table("Data/Base_Files/PilotDistSchRev1.csv", header=FALSE, sep="|", skip=1, colClasses=rep("character", 3))
SIG_District_Schools <- read.table("Data/Base_Files/SIGDistSchRev1.csv", header=FALSE, sep="|", skip=1, colClasses=rep("character", 3))
names(Pilot_District_Schools) <- c("SCHOOL_NUMBER", "DISTRICT_NAME", "SCHOOL_NAME")
names(SIG_District_Schools) <- c("SCHOOL_NUMBER", "DISTRICT_NAME", "SCHOOL_NAME")
Pilot_District_Schools$SCHOOL_NUMBER <- as.factor(Pilot_District_Schools$SCHOOL_NUMBER)
SIG_District_Schools$SCHOOL_NUMBER <- as.factor(SIG_District_Schools$SCHOOL_NUMBER)


### Define relevant quantities

MS_content_areas <- c("ALGEBRA", "BIOLOGY", "ENGLISH", "MATHEMATICS", "READING_LANGUAGE_ARTS")
## 2011 CONTENT_AREA MS_content_areas <- c("ALGEBRA", "BIOLOGY", "HISTORY", "ENGLISH", "MATHEMATICS", "READING_LANGUAGE_ARTS")
...
bPlot.data.school <- subset(bPlot.data.school, YEAR=="2011_2012")
...
bPlot.data.school.grade <- subset(bPlot.data.school.grade, YEAR=="2011_2012")
...
bPlot.data.instructor <- subset(bPlot.data.instructor, YEAR=="2011_2012")
...
bPlot.data.instructor.grade <- subset(bPlot.data.instructor.grade, YEAR=="2011_2012")
...
write.table(bPlot.data.school, file="Data/Mississippi_District_by_School_Summary_Data.dat", na="", row.names=FALSE, quote=FALSE, sep="|")
write.table(bPlot.data.school.grade, file="Data/Mississippi_District_by_School_by_Grade_Summary_Data.dat", na="", row.names=FALSE, quote=FALSE, sep="|")
write.table(bPlot.data.instructor, file="Data/Mississippi_District_by_School_by_Instructor_Summary_Data.dat", na="", row.names=FALSE, quote=FALSE, sep="|")
write.table(bPlot.data.instructor.grade, file="Data/Mississippi_District_by_School_by_Instructor_by_Grade_Summary_Data.dat", na="", row.names=FALSE, quote=FALSE, sep="|")
...
bubblePlot(
        ...
        bubble_plot_labels.X=c("Growth", "2011-2012 Median Student Growth Percentile"),
        bubble_plot_labels.Y=c("Achievement", "2011-2012 Percent at/above Proficient"),
        bubble_plot_labels.SIZE=c(50, 100, 250, 500),
        bubble_plot_labels.LEVELS=NULL,
        bubble_plot_labels.BUBBLE_TIPS_LINES=list(
                "2011-2012 Median SGP (Count)",
                "2 Year Median SGP (Count)",
                "2011-2012 Percent at/above Proficient (Count)"),
        ...
        bubble_plot_titles.SUB2=paste("2011-2012", test_label, capwords(i)),
        ...
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2011_2012", capwords(i), "State_School_Performance", sep="_"), ".pdf", sep=""),
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste(j, "2011_2012", capwords(i), "School_Performance", sep="_"), ".pdf", sep=""),
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2011_2012", capwords(i), "State_Teacher_Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
...
bubblePlot(
        ...
        bubble_plot_labels.X=c("Growth", "2011-2012 Median Student Growth Percentile"),
        bubble_plot_labels.Y=c("Achievement", "2010-2011 Prior Percent at/above Proficient"),
        bubble_plot_labels.SIZE=c(10, 25, 50, 100),
        bubble_plot_labels.LEVELS=NULL,
        bubble_plot_labels.BUBBLE_TIPS_LINES=list(
                "2011-2012 Median SGP (Count)",
                "2 Year Median SGP (Count)",
                "2010-2011 Prior Percent at/above Proficient (Count)"),
        bubble_plot_labels.BUBBLE_TITLES=paste(tmp.bPlot.data.instructor[["DISTRICT_NAME"]], ": ", tmp.bPlot.data.instructor[["SCHOOL_NAME"]], " -- ", tmp.bPlot.data.instructor[["INSTRUCTOR_FIRST_NAME"]], " ", tmp.bPlot.data.instructor[["INSTRUCTOR_LAST_NAME"]], sep=""),
        bubble_plot_titles.MAIN="MCT2 Growth & Achievement",
        bubble_plot_titles.SUB1="Mississippi Teacher Performance",
        bubble_plot_titles.SUB2=paste("2011-2012 MCT2", capwords(i)),
        bubble_plot_titles.LEGEND1="Classroom Size",
        bubble_plot_titles.LEGEND2_P1=NULL,
        bubble_plot_titles.LEGEND2_P2=NULL,
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2011_2012", capwords(i), "State_Teacher_Performance (Prior Achievement)", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste(j, "2011_2012", capwords(i), "Teacher_Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "District", j),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste(j, "2011_2012", capwords(i), "Teacher_Performance (Prior Achievement)", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "District", j),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
}
...
#        bubble_plot_titles.MAIN="MCT2 Growth & Achievement",
#        bubble_plot_titles.SUB1=paste(j, "School Performance"),
#        bubble_plot_titles.SUB2=paste("2011-2012 MCT", capwords(i)),
#        bubble_plot_titles.LEGEND1="School Size",
#        bubble_plot_titles.LEGEND2_P1=NULL,
#        bubble_plot_titles.LEGEND2_P2=NULL,
#
...
#        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
#        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
#        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste(k, "2011_2012", capwords(i), "Performance", sep="_"), ".pdf", sep=""),
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2011_2012", capwords(i), "Pilot_School Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2011_2012", capwords(i), "Pilot_School Teacher Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2011_2012", capwords(i), "Pilot_School Teacher Performance (Prior Achievement)", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2011_2012", capwords(i), "Grade", j, "Pilot_School_Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2011_2012", capwords(i), "SIG_School_Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2011_2012", capwords(i), "SIG_School_Teacher Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2011_2012", capwords(i), "SIG_School_Teacher Performance (Prior Achievement)", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2011_2012", capwords(i), "Grade", j, "SIG_School_Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste("MS_2011_2012", capwords(i), "Grade", j, "Performance", sep="_"), ".pdf", sep=""),
        bubble_plot_configs.BUBBLE_PLOT_PATH=file.path("Visualizations", "bubblePlots", "State"),
        bubble_plot_pdftk.CREATE_CATALOG=FALSE)
}
}
...
bubblePlot(
        ...
        bubble_plot_configs.BUBBLE_PLOT_TITLE="TRUE",
        bubble_plot_configs.BUBBLE_PLOT_EXTRAS=bPlot.message,
        bubble_plot_configs.BUBBLE_PLOT_NAME=paste(paste(k, "2011_2012", capwords(i), "Grade", j, "Performance", sep="_"), ".pdf", sep=""),
